...
module.exports = {
  substrateNetwork: process.env.SUBSTRATE_NETWORK || 'paralink',
  wsProviderUrl: process.env.WS_PROVIDER_URL || 'ws://substrate-node:9944',
  postgresConnParams: {
    user: process.env.POSTGRES_USER || 'paralink',
    host: process.env.POSTGRES_HOST || 'postgres',
    database: process.env.POSTGRES_DATABASE || 'paralink',
    password: process.env.POSTGRES_PASSWORD || 'paralink',
